...
export default function DocsPage() {
  return (
    <main style={{ maxWidth: 900, padding: "2rem", lineHeight: "1.8" }}>
      <h1 style={{ fontSize: "2.5rem", marginBottom: "1rem", textAlign: "center" }}>
        🎓 How School Eligibility Works
      </h1>
      
      <div className="card" style={{ marginBottom: "2rem", background: "rgba(79, 209, 197, 0.1)", borderLeft: "4px solid #4fd1c5" }}>
        <h2 style={{ color: "#4fd1c5", marginBottom: "1rem" }}>The Problem We're Solving</h2>
        <p>
      ...
      <div className="card" style={{ marginBottom: "2rem" }}>
        <h2 style={{ color: "#4fd1c5", marginBottom: "1rem" }}>🔐 How FHE Protects Your Privacy</h2>
        
        <h3 style={{ color: "#00e6a0", marginTop: "1.5rem", marginBottom: "0.75rem" }}>What is FHE? (In Simple Terms)</h3>
      ...
      <div className="card" style={{ marginBottom: "2rem" }}>
        <h2 style={{ color: "#4fd1c5", marginBottom: "1rem" }}>📊 The Point-Based System</h2>
        
        <div style={{ display: "grid", gap: "1.5rem" }}>
          <div>
            <h3 style={{ color: "#8b5cf6" }}>1. Age Score (20 points max) 🎂</h3>
            ...
            <p style={{ marginTop: "0.75rem", color: "#a0aec0", fontSize: "0.95rem" }}>
              <em>We believe education should be accessible to everyone, regardless of age.</em>
            </p>
          </div>

          <div>
            <h3 style={{ color: "#3b82f6" }}>2. Exam Score (40 points max) 📚</h3>
            <ul style={{ paddingLeft: "1.5rem", marginTop: "0.5rem" }}>
          ...
          <div>
            <h3 style={{ color: "#f59e0b" }}>4. Extracurricular (10 points max) ⚽</h3>
          ...
          <div>
            <h3 style={{ color: "#ef4444" }}>5. Interview Score (10 points max) 💬</h3>
      ...
      <div className="card" style={{ marginBottom: "2rem", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", color: "white" }}>
        <h2 style={{ marginBottom: "1rem" }}>🎯 The Passing Score: 70/100</h2>
      ...
      <div className="card" style={{ marginBottom: "2rem" }}>
        <h2 style={{ color: "#4fd1c5", marginBottom: "1rem" }}>📖 Example Success Stories</h2>
        
        <div style={{ display: "grid", gap: "1.5rem" }}>
          <div style={{ padding: "1rem", background: "rgba(79, 209, 197, 0.05)", borderRadius: "8px", borderLeft: "3px solid #4fd1c5" }}>
            <h4 style={{ color: "#4fd1c5", marginBottom: "0.75rem" }}>Meet Sarah (Age 15)</h4>
            ...
            <p style={{ marginTop: "0.75rem", fontSize: "1.1rem", fontWeight: "bold", color: "#00e6a0" }}>
              Total: 82 points ✅ ELIGIBLE!
            </p>
          </div>

          <div style={{ padding: "1rem", background: "rgba(79, 209, 197, 0.05)", borderRadius: "8px", borderLeft: "3px solid #4fd1c5" }}>
            <h4 style={{ color: "#4fd1c5", marginBottom: "0.75rem" }}>Meet James (Age 28)</h4>
            <ul style={{ paddingLeft: "1.5rem", fontSize: "0.95rem" }}>
          ...
          <div style={{ padding: "1rem", background: "rgba(79, 209, 197, 0.05)", borderRadius: "8px", borderLeft: "3px solid #4fd1c5" }}>
            <h4 style={{ color: "#4fd1c5", marginBottom: "0.75rem" }}>Meet Maria (Age 42)</h4>
            <ul style={{ paddingLeft: "1.5rem", fontSize: "0.95rem" }}>
      ...
      <div className="card" style={{ marginBottom: "2rem", background: "rgba(239, 68, 68, 0.1)", borderLeft: "4px solid #ef4444" }}>
        <h2 style={{ color: "#ef4444", marginBottom: "1rem" }}>💡 Key Takeaways</h2>
      ...
      <div style={{ marginTop: "3rem", textAlign: "center", color: "#a0aec0", fontSize: "0.9rem" }}>
